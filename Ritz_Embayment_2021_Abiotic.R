...
important_datesA <- as.Date(c("2025-06-24", "2025-07-09"))
...
DEPTH_Appendix_Plot<- ggplot(Depth_Appendix, aes(Date, DEPTH_mean, 
  group=Year, lty=Year, color=Year))+
  geom_point(size=0.8)+
  ...
  scale_color_manual(values = c("black", "#999999", "black", "#999999"))+
  geom_vline(xintercept = as.numeric(important_datesA), 
             color = "black", linetype = "dotted", size = 2) +
  theme(
        legend.position ="right", legend.title = element_blank(),
        legend.text = element_text(size=17), axis.title.x = element_blank(),
...
DO_Eel_plot<- ggplot(Abiotic_DO_Eel, aes(Date, Measurement, 
                  group=Type, lty=Type))+
  geom_hline(yintercept = 3, color=c("grey"), size=1.6)+
  geom_point(size=0.8)+
  ...
  theme(legend.title = element_blank(), 
        ...
        axis.title.x = element_blank(),
        plot.title = element_text(hjust = 0.5, size=18))+guides(lty = guide_legend(nrow = 1))
...
TEMP_Eel_plot<- ggplot(Abiotic_TEMP_Eel, aes(Date, Measurement, group=Type, lty=Type)) +
  ...
  scale_y_continuous(breaks=seq(14,34,5), limits=c(14,36))+
  ...
  theme(legend.title = element_blank(), 
        ...
        axis.title = element_text(size=17),
        axis.title.x = element_blank(),
        plot.title = element_text(hjust = 0.5, size=17))+guides(lty = guide_legend(nrow = 1))
TEMP_Eel_plot
